...
function TubularSurgeArresterNode({ selected, data, id }: NodeProps) {
  ...
  const icon = applied ? (
    <TubularSurgeArresterIcon stroke={applied} fill={applied} />
  ) : (
    <TubularSurgeArresterIcon />
  );
...
export default TubularSurgeArresterNode;