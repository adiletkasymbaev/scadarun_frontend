...
export type OnSwitchgearCellWithDisconnectorColors = {
  stroke?: string;
  fill?: string;
};

export const OnSwitchgearCellWithDisconnectorIcon = ({
  stroke = "#EA7474",
  fill = "#EA7474",
  ...props
}: IconBaseProps & OnSwitchgearCellWithDisconnectorColors) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#clip0_switchgear_cell_disconnector)">
      <line
        y1="-2"
        x2="24.1868"
        y2="-2"
    ...
    <defs>
      <clipPath id="clip0_switchgear_cell_disconnector">
